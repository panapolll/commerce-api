...
async function bootstrap() {
  ...
  const products = [
    ...
    },
    {
      name: 'ทุเรียน',
      description:
        'ทุเรียน กลิ่นสุดเอียนที่สวยลุงศักดิ์ ใครจะกินก็กิน ผมไม่กิน',
      price: 500,
      stock: 30,
      category: 'fruit',
    },
    ...
    },
    {
      name: 'ลำไย',
      description:
        'ลำไยสุดหวาน หวานเรียกพ่อ ขมเรียกพี่ แต่อย่ากินดีกว่า ',
      price: 60,
      stock: 150,
      category: 'fruit',
    },
    ...
    },
    {
      name: 'แก้วมังกร',
      description:
        'แก้วมังกรแสนอร่อย กินบ่อยๆ อาจจะติดใจ นานๆ ไปอาจติดเตียง',
      price: 40,
      stock: 120,
      category: 'fruit',
    },
